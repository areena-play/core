import { z } from 'zod';
import { AssociationLevel, Gender, LicenseType, CompetitionType, GenderRestriction, MessageChannel, InvoiceStatus, InvoiceCategory, InvoiceTargetType } from '../types';
...
export declare const updateAssociationSettingsSchema: z.ZodObject<{
...
export declare const invoiceLineItemSchema: z.ZodObject<{
    ...
    bexioArticleId: z.ZodNullable<z.ZodOptional<z.ZodNumber>>;
}, "strip", z.ZodTypeAny, {
    description: string;
    quantity: number;
    unit: string;
    ...
    bexioArticleId?: number | null | undefined;
}, {
    description: string;
    unitPrice: number;
    id?: string | undefined;
...
export declare const createInvoiceSchema: z.ZodObject<{
    associationId: z.ZodNullable<z.ZodOptional<z.ZodString>>;
    clubId: z.ZodNullable<z.ZodOptional<z.ZodString>>;
    targetType: z.ZodDefault<z.ZodNativeEnum<typeof InvoiceTargetType>>;
    recipientClubId: z.ZodNullable<z.ZodOptional<z.ZodString>>;
    recipientUserId: z.ZodNullable<z.ZodOptional<z.ZodString>>;
    ...
    category: z.ZodDefault<z.ZodNativeEnum<typeof InvoiceCategory>>;
    ...
    syncToBexio: z.ZodDefault<z.ZodOptional<z.ZodBoolean>>;
}, "strip", z.ZodTypeAny, {
    taxRate: number;
    ...
    recipientClubId?: string | null | undefined;
    ...
    notes?: string | null | undefined;
    taxRate?: number | undefined;
    targetType?: InvoiceTargetType | undefined;
    recipientClubId?: string | null | undefined;
    recipientUserId?: string | null | undefined;
    recipientEmail?: string | null | undefined;
    recipientAddress?: string | null | undefined;
...
export declare const bexioConfigSchema: z.ZodObject<{
    associationId: z.ZodNullable<z.ZodOptional<z.ZodString>>;
    clubId: z.ZodNullable<z.ZodOptional<z.ZodString>>;
    apiToken: z.ZodNullable<z.ZodOptional<z.ZodString>>;
    bankAccountId: z.ZodNullable<z.ZodOptional<z.ZodNumber>>;
    taxId: z.ZodNullable<z.ZodOptional<z.ZodNumber>>;
    paymentTypeId: z.ZodNullable<z.ZodOptional<z.ZodNumber>>;
    iban: z.ZodNullable<z.ZodOptional<z.ZodString>>;
    qrIban: z.ZodNullable<z.ZodOptional<z.ZodString>>;
    companyName: z.ZodNullable<z.ZodOptional<z.ZodString>>;
    companyAddress: z.ZodNullable<z.ZodOptional<z.ZodString>>;
...
export declare const auditLogQuerySchema: z.ZodObject<{
    associationId: z.ZodOptional<z.ZodString>;

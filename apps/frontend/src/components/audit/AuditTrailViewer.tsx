...
export function AuditTrailViewer({
    ...
    return (
        <div className="space-y-6">
            ...
            {inspectLog && (
                <ModalPortal>
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-in fade-in-50">
                        <div className="w-full max-w-2xl rounded-2xl border border-slate-200 bg-white p-6 shadow-2xl dark:border-slate-800 dark:bg-slate-900 max-h-[90vh] overflow-y-auto space-y-5">
                            {/* Modal Header */}
                                    ...
                                    <div className="flex items-center gap-2">
                                        <span
                                            className={`rounded-md border px-2 py-0.5 text-[10px] font-bold ${
                                                getCategoryBadge(inspectLog.category).color
                                            }`}
                                        >
                                            {inspectLog.category}
                                        </span>

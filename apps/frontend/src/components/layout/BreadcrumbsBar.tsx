...
const SEGMENT_METADATA: Record<string, { labelKey?: string; fallback: string; icon?: any }> = {
    ...
    teams: { fallback: 'Team Hub', icon: Trophy },
    'team-hub': { fallback: 'Team Hub', icon: Trophy },
    ...
    tournaments: { fallback: 'Tournament Hub', icon: Trophy },
    'tournament-hub': { fallback: 'Tournament Hub', icon: Trophy },
    cups: { fallback: 'Cups', icon: Trophy },
    cup: { fallback: 'Cup', icon: Trophy },

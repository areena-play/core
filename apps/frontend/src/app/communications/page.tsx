    ...
    <div className="space-y-8 pb-16">
      ...
      <div>
        ...
        <p className="text-sm text-slate-400">
          Direct communication tool for federation and club administrators to contact members via Email and SMS.
        </p>
      </div>
            ...
            {messages.map((m) => (
              ...
              >
                ...
                <div className="pt-2 border-t border-slate-800/80 flex items-center justify-between text-slate-400 text-[11px]">
                  <span>Sent by: {m.sender?.firstName} {m.sender?.lastName}</span>

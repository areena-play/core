            ...
            <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                <div>
                    ...
                    <p className="text-sm text-slate-400">
                        Secure OAuth 2.0 Client Credentials API. Public access for verified accounts, with Main
                        Association Admin approval for enhanced partner scopes.
                    </p>
                </div>
                            ...
                            >
                                ...
                                <div className="space-y-1.5 font-mono text-[11px] rounded-lg bg-slate-950 border border-slate-800 p-2.5">
                                    <div className="flex items-center justify-between text-slate-300">
                                        <span>
                                            Client ID: <strong className="text-red-400">{c.clientId}</strong>
                                        </span>
                                        <button
                                            onClick={() => {
                                ...
                                <div>
                                    ...
                                    <div className="mt-2 space-y-2">
                                        {[
                                            ...
                                            <label
                                                key={s.scope}
                                                className="flex items-start gap-2.5 cursor-pointer rounded-lg border border-slate-800 bg-slate-950 p-2.5"
                                            >
                                                <input
                                                    type="checkbox"

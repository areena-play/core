                ...
                <div className="space-y-5">
                    ...
                    <div className="flex items-center gap-2 overflow-x-auto pb-1 scrollbar-none border-b border-slate-200 dark:border-slate-800">
                        {[
                            ...
                            <button
                                ...
                                className={`inline-flex items-center gap-2 px-3.5 py-2.5 text-xs font-bold border-b-2 transition whitespace-nowrap ${
                                    activeTab === tab.id
                    ...
                    {loading ? (
                        <div className="py-12 text-center space-y-3">
                            ...
                            <p className="text-xs text-slate-500">Searching across AREENA database...</p>
                        </div>

      ...
      <div className="w-full max-w-lg space-y-6">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900/80 p-6 md:p-8 shadow-sm dark:shadow-xl space-y-5 text-xs">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div>
              <label className="font-semibold text-slate-700 dark:text-slate-300">Email Address (serves as Username)</label>
              <input
                type="email"
                required
            ...
            <div>
              <label className="font-semibold text-slate-700 dark:text-slate-300">Password (min 8 characters)</label>
              <input
                type="password"
                required
                minLength={8}

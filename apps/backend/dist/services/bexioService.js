...
exports.BexioService = void 0;
class BexioService {
    static BEXIO_API_V2 = 'https://api.bexio.com/2.0';
    /**
     * Tests connectivity with Bexio using the provided API token.
     */
    static async testConnection(apiToken) {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                return {
                    connected: false,
                    error: errorData.message || `Bexio returned HTTP ${response.status}`,
                };
            }
     ...
     */
    static async syncContact(apiToken, contact) {
        if (apiToken.startsWith('bexio_sim_') || apiToken === 'demo' || apiToken.length < 10) {
     ...
     */
    static async syncInvoice(invoice, bexioConfig) {
        ...
        const isSimulated = apiToken.startsWith('bexio_sim_') || apiToken === 'demo' || apiToken.length < 10;
        if (isSimulated) {
     ...
     */
    static generateSwissQrPayload(invoice, bexioConfig) {
...
exports.BexioService = BexioService;

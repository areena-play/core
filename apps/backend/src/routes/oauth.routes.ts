...
router.post('/clients', authenticateToken, validate(createOAuthClientSchema), async (req: AuthRequest, res: Response, next) => {
  try {
...
router.get('/api/v1/federation', authenticateOAuthToken, requireOAuthScope('read:public'), async (req: OAuthRequest, res: Response, next) => {
  try {
...
router.get('/api/v1/calendar', authenticateOAuthToken, requireOAuthScope('read:calendar'), async (req: OAuthRequest, res: Response, next) => {
  try {
...
router.get('/api/v1/competitions', authenticateOAuthToken, requireOAuthScope('read:competitions'), async (req: OAuthRequest, res: Response, next) => {
  try {
...
router.get('/api/v1/members', authenticateOAuthToken, requireOAuthScope('read:members_full'), async (req: OAuthRequest, res: Response, next) => {
  try {

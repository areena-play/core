...
router.post('/', authenticateToken, validate(createCompetitionSchema), async (req: AuthRequest, res: Response, next) => {
  try {
...
router.post('/:id/categories', authenticateToken, validate(createCategorySchema), async (req: AuthRequest, res: Response, next) => {
  try {
    const {
      name,
      teamSize,
...
router.put('/matches/:matchId/score', authenticateToken, validate(updateMatchScoreSchema), async (req: AuthRequest, res: Response, next) => {
  try {
